...
train_dataset = build_dataset_from_X_Y(X_train, Y_train, all_class, train_with_labels, label_mode, img_size,
                                        BATCH_SIZE, train_repeat, train_shuffle, train_augment, im_size_before_crop, tool_gen_mask)
...
valid_dataset = build_dataset_from_X_Y(X_valid, Y_valid, all_class, valid_with_labels, label_mode, img_size,
                                        BATCH_SIZE, valid_repeat, valid_shuffle, valid_augment, None, tool_gen_mask)
...
if pretrained_model is not None:
    try:
        ...
        print('Loaded pretrain from', pretrained_model)
    except:
        print('Failed to load pretrain from', pretrained_model)
